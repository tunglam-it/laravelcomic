...
@section('title')
    <title>Cập nhật Chapter Truyện</title>
@endsection
@section('minor_content')
    <div class="content-wrapper">
        <!-- Content Header (Page header) -->
    @include('admin.layouts.content-header',['minorTitle'=>'Cập nhật Chapter Truyện'])
    <!-- Main content -->
            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-3">
                        <form action="{{route('admin.chapter.update',['id'=>$chapter->id])}}" method="post"
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <textarea name="description"
                                              ...
                                              id="chapterDescription" rows="5">{{$chapter->description}}</textarea>
                                    @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <textarea name="chapter_content"
                                              ...
                                              id="chapterContent">{{$chapter->chapter_content}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm @error('comic_id') is-invalid @enderror" name="comic_id">
                                    ...
                                    @foreach($comics as $comic)
                                        <option
                                            value="{{$comic->id}}"{{$chapter->comic_id==$comic->id?'selected':''}}>{{$comic->name}}</option>
                                    @endforeach
                                </select>
                                @error('comic_id')
                                <div class="text-danger">{{ $message }}</div>
