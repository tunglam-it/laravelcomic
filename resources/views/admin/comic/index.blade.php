...
@section('minor_content')
    ...
    @include('admin.layouts.content-header',['minorTitle'=>'Truyện'])
    <!-- Main content -->
        <section class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <span class="card-title"><a href="{{route('admin.comic.create')}}" class="btn btn-success">Thêm mới</a></span>
                        @if(session('message'))
...
@endsection
@section('js')
    <script src="{{asset('admin/assets/js/ajax/ajax.comic.js')}}"></script>
@endsection
